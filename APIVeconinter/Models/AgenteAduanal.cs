...
namespace APIVeconinter.Models
{
    ...
    public partial class AgenteAduanal
    {
        ...
        public string RifAgenteAduanal { get; set; }
        public string NombreAgenteAduanal { get; set; }
        public string DireccionAgenteAduanal { get; set; }
        public string TelefonoAgenteAdualnal { get; set; }
        public string EmailAgenteAduanal { get; set; }
